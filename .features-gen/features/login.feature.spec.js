...
test.describe('Login', () => {
  ...
  test('Successful login with valid credentials', async ({ When, loginPage, And, Then, page }) => { 
    await When('user enters valid credentials', null, { loginPage }); 
    await And('clicks Login button', null, { loginPage }); 
    await Then('account is successfully logged in', null, { loginPage, page }); 
  });
  ...
  test('Unsuccessful login with invalid password', async ({ When, loginPage, And, Then }) => { 
    ...
    await And('clicks Login button', null, { loginPage }); 
    await Then('show wrong credential login error', null, { loginPage }); 
  });
  ...
  test('Unsuccessful login with unregistered email', async ({ When, loginPage, And, Then }) => { 
    ...
    await And('clicks Login button', null, { loginPage }); 
    await Then('show unregistered email login error', null, { loginPage }); 
  });
