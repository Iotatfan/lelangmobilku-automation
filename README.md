...
| TC-LOG-003 | Unsuccessful login with unregistered email | Show error message "Username tidak ditemukan/salah" | Equivalence Partitioning | Test the invalid partition of incorrect credentials |
